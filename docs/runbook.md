...
4. `python -m forecast_select backtest --models catboost` runs the full monthly-grouped CatBoost challenger into a new Level-A artifact; failures remain in the Parquet and ledger.
